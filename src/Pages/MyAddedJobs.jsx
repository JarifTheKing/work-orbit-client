      ...
      {myJobs.length === 0 ? (
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {myJobs.map((job) => (
            <div
              key={job._id}
              className="group flex flex-col bg-white dark:bg-gray-800 rounded-2xl shadow-md hover:shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden transition-all duration-300"
            >
              {/* Job Image */}
              ...
              <div className="flex flex-col flex-grow justify-between p-5">
                <div>
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <span className="px-3 py-1 text-xs bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-300 rounded-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-snug line-clamp-2 mb-4">
